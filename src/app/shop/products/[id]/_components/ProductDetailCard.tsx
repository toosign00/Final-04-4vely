      ...
      <div className='lg:hidden'>
        ...
        <div className='relative mx-4 mt-4 aspect-square w-auto rounded-2xl bg-white sm:mx-6 sm:mt-6 md:mx-8 md:mt-8'>
          ...
          <div className='absolute top-3 right-3 sm:top-4 sm:right-4'>
            <BookmarkButton productId={getProductId(product)} myBookmarkId={product.myBookmarkId} size={32} variant='default' className='sm:scale-110 md:scale-125' />
          </div>
        </div>
          ...
          <div className='mb-24 flex gap-12 xl:gap-20'>
            ...
            <div className='relative aspect-square w-full max-w-[800px] min-w-[280px] flex-1'>
              ...
              <div className='absolute top-4 right-4'>
                <BookmarkButton productId={getProductId(product)} myBookmarkId={product.myBookmarkId} size={48} variant='default' />
              </div>
            </div>
