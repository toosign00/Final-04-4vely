...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Root>) {
  ...
  return <Label data-slot='form-label' data-error={!!error} className={cn('t-body data-[error=true]:text-destructive', className)} htmlFor={formItemId} {...props} />;
}
...
function FormDescription({ className, ...props }: React.ComponentProps<'p'>) {
  ...
  return <p data-slot='form-description' id={formDescriptionId} className={cn('t-desc text-muted-foreground text-sm', className)} {...props} />;
}
